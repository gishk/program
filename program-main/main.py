...
def controler_keyboard_2(name_kb):
    markup = types.InlineKeyboardMarkup()
    if name_kb == 'pf_1':
        b1 = types.InlineKeyboardButton(text='Боевик')
        b2 = types.InlineKeyboardButton(text='Ужасы')
        markup.add(b1, b2)
    return markup
...
def main_controler(message): 
    ...
    if message.text == 'Жанры':
        bot.send_message(uid, 'Вот список жанров:', reply_markup=controler_keyboard_2('pf_1'))
